...
// const uint8_t Inqure_WindDirection[CMDLength]={0x02,0x03,0x00,0x01,0x00,0x01,0xD5,0xF9};      	//风向RK
const uint8_t Inqure_WindDirection[CMDLength]={0x02,0x03,0x00,0x00,0x00,0x01,0x84,0x39};      	//风向XPH
